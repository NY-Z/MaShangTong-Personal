...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    RegisViewController *companyHome = [[RegisViewController alloc] init];
    UINavigationController *companyHomeNavi = [[UINavigationController alloc] initWithRootViewController:companyHome];
    self.window.rootViewController = companyHomeNavi;
